...
void Bow::Attack(facingDirections projectileDirection, glm::vec2 spawnPos, Hudson::World::Scene* CurrentScene, float _playerAttackMod)
{
	_projectile = new Hudson::Entity::GameObject();
	_projectile->AddComponent(new Projectile(projectileDirection, spawnPos, CurrentScene, WT_Bow, _weaponAttackDamage *_playerAttackMod, _projectileMovementSpeed, _projectileRange));
